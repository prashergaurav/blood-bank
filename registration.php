...
<tr><td class="lefttd"> Blood Group </td><td><select name="t4" required><option value=""></option>
<?php
$cn=makeconnection();
...
<tr><td class="lefttd"> State </td><td><select name="t4" required><option value=""></option>
<?php
$cn=makeconnection();
$s="select * from bloodgroup";
	$result=mysqli_query($cn,$s);
...
<tr><td class="lefttd"> District </td><td><select name="t4" required><option value=""></option>
<?php
$cn=makeconnection();
$s="select * from bloodgroup";
	$result=mysqli_query($cn,$s);
...
<tr><td class="lefttd"> Town </td><td><select name="t4" required><option value=""></option>
<?php
$cn=makeconnection();
$s="select * from bloodgroup";
	$result=mysqli_query($cn,$s);
...
<tr>
<td class="lefttd">E-Mail</td><td><input type="email" name="t5" required="required" /></td></tr>
...
<tr><td>&nbsp;</td><td><input type="submit" value="Resitred" name="sbmt" style="border:0px; background:linear-gradient(#900,#D50000); width:
100px; height:30px; border-radius:10px 1px 10px 1px; box-shadow:1px 1px 5px black; color:white; font-weight:bold; font-size:14px; text-shadow:1px 1px 6px black; "></td></tr></table>
</td></tr>
</table>
</form>
        </div>
